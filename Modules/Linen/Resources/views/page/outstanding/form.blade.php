<div class="form-group">
    ...
    {!! Form::label('name', __('Company'), ['class' => 'col-md-1 control-label']) !!}
    <div class="col-md-3 {{ $errors->has('linen_outstanding_scan_company_id') ? 'has-error' : ''}}">
    ...
    {!! Form::label('name', __('No. Seri RFID'), ['class' => 'col-md-1 control-label']) !!}
    <div class="col-md-3 {{ $errors->has('linen_outstanding_rfid') ? 'has-error' : ''}}">
    ...
    <div class="col-md-3 {{ $errors->has('linen_outstanding_status') ? 'has-error' : ''}}">
