...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('report_linen_company_id') ? 'has-error' : ''}}">
        {{ Form::select('report_linen_company_id', $company, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('report_linen_company_id', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', __('Location'), ['class' => 'col-md-2 col-sm-2 control-label']) !!}
    <div class="col-md-4 col-sm-4 {{ $errors->has('report_linen_location_id') ? 'has-error' : ''}}">
        {{ Form::select('report_linen_location_id', $location, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('report_linen_location_id', '<p class="help-block">:message</p>') !!}
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('report_linen_product_id') ? 'has-error' : ''}}">
        {{ Form::select('report_linen_product_id', $product, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('report_linen_product_id', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', __('Rental'), ['class' => 'col-md-2 col-sm-2 control-label']) !!}
    <div class="col-md-4 col-sm-4 {{ $errors->has('report_linen_rent') ? 'has-error' : ''}}">
        {{ Form::select('report_linen_rent', $rental, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('report_linen_rent', '<p class="help-block">:message</p>') !!}
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('report_linen_created_by') ? 'has-error' : ''}}">
        {{ Form::select('report_linen_created_by', $user, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('report_linen_created_by', '<p class="help-block">:message</p>') !!}
    </div>
