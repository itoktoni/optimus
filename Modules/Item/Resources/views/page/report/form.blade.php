...
<div class="form-group">
    ...
    {!! Form::label('name', 'Rumah Sakit', ['class' => 'col-md-2 control-label']) !!}
    ...
    {!! Form::label('name', 'Ruangan', ['class' => 'col-md-2 control-label']) !!}
...
<div class="form-group">
    ...
    {!! Form::label('name', 'Linen', ['class' => 'col-md-2 control-label']) !!}
...
<div class="form-group">
    ...
    {!! Form::label('name', 'Di Register Oleh', ['class' => 'col-md-2 control-label']) !!}
    ...
    {!! Form::label('name', 'Di Update Oleh', ['class' => 'col-md-2 control-label']) !!}
