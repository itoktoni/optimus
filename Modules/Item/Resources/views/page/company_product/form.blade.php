<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('company_id') ? 'has-error' : ''}}">
...
<div class="form-group">
    ...
    {!! Form::label('name', __('Size'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('company_item_size_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4 {{ $errors->has('company_item_unit_id') ? 'has-error' : ''}}">
...
<div class="form-group">
    ...
    {!! Form::label('name', __('Minimal'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('company_item_minimal') ? 'has-error' : ''}}">
        {!! Form::text('company_item_minimal', null, ['class' => 'form-control']) !!}
        {!! $errors->first('company_item_minimal', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', __('Maximal'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('company_item_maximal') ? 'has-error' : ''}}">
...
<div class="form-group">
    ...
    {!! Form::label('name', __('Target'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('company_item_target') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4 {{ $errors->has('company_item_weight') ? 'has-error' : ''}}">
