<div class="form-group">
    {!! Form::label('holding_name', 'Name', ['class' => 'col-md-2 control-label']) !!}
    ...
    {!! Form::label('holding_person', 'Contact Person', ['class' => 'col-md-2 control-label']) !!}
...
<div class="form-group">
    {!! Form::label('holding_email', 'Email', ['class' => 'col-md-2 control-label']) !!}
    ...
    {!! Form::label('holding_phone', 'Phone', ['class' => 'col-md-2 control-label']) !!}
